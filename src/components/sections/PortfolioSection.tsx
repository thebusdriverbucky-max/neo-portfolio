  ...
  const fallbackProjects: Project[] = [
    {
      ...
      technologies: ['Next.js', 'TypeScript', 'Tailwind CSS', 'React', 'Stripe'],
      demoUrl: 'https://www.ownyourwebsite.app/',
      githubUrl: null,
      longDescription: 'Template Marketplace - Платформа для шаблонов без подписки. Покупка и продажа высокопроизводительных веб-шаблонов без ежемесячных платежей.',
      featured: true,
      order: 1,
      createdAt: new Date(),
      updatedAt: new Date(),
